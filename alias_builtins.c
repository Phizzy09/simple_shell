...
/**
 * shellby_alias - The builtin command either prints all aliases, specific
...
/**
 * set_alias - It either set an existing alias 'name' with a new value,
...
/**
 * replace_aliases - this goes through arguments and replace any matching alias
 * with their value.
